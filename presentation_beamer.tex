...
\begin{frame}{Portefeuilles Long-Short: M\'ethodologie}
...
\begin{frame}{Volatility Scaling}
    \begin{block}{Objectif}
        Normaliser tous les facteurs \`a \textbf{10\% de volatilit\'e annualis\'ee ex-ante}
    \end{block}
    ...
    \begin{alertblock}{Avantage}
        Permet de comparer les facteurs sur une base de risque \'equivalente
    \end{alertblock}
\end{frame}
...
\begin{frame}{Framework Bay\'esien}
    ...
    \begin{alertblock}{Effet du Shrinkage}
...
\begin{frame}{Optimisation sous Contraintes}
    ...
    \begin{alertblock}{R\'esultat}
        Tracking Error moyen $\approx 2-3\%$ (cible du papier)
    \end{alertblock}
\end{frame}
...
\begin{frame}{Justification: Pr\'edicteurs Manquants}
    \begin{block}{3 Pr\'edicteurs Non Impl\'ement\'es}
        \begin{enumerate}
